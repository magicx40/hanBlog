...
var CanvasRenderer = Class.create( /** @lends CanvasRenderer.prototype */ {
    ...
    constructor: function(properties) {
        ...
        this.canvasBuffer.width = this.context.width;  
        this.canvasBuffer.height = this.context.height;
...
startDraw: function(target) {
        if (target.visible && target.alpha > 0) {
            if (target === this.stage) {
                this.contextBuffer.clearRect(0, 0, target.width, target.height);
            }
            if (target.blendMode !== this.blendMode) {
                this.contextBuffer.globalCompositeOperation = this.blendMode = target.blendMode;
            }
     ...
     */
    clear: function(x, y, width, height) {
        this.contextBuffer.clearRect(x, y, width, height);
    },
...
return Class.create(/** @lends Graphics.prototype */{
    ...
    render: function(renderer, delta){
        ...
        if(renderer.renderType === 'canvas'){
            ...
            me._draw(renderer.contextBuffer);
        }else{
            me.cache();
            renderer.draw(me);
        }
...
(function(window){
  ...
  var BubbleText = Class.create(/** @lends Text.prototype */{
    ...
    constructor: function(properties){
      ...
      this.speechBubble =  new SpeechBubble(context,this.chat,this.scalePanel,this.shardowEffect,this.panelBorderColor,this.panelFillColor,this.panelBorderWidth,this.fontColor,this.fontSize,this.fixedSize,this.width,this.height,this.fontName);
      //this.speechBubble.text = me.text;
    },
    text: null,
    color: '#000',
    textAlign: null,
