...
var Text = Class.create(/** @lends Text.prototype */{
    ...
    constructor: function(properties){
        ...
        this.isCenter = (typeof properties.isCenter != "undefined") ? properties.isCenter : false;
        this.roundFill = (typeof properties.roundFill != "undefined") ? properties.roundFill : false;
    },
    ...
    _draw: function(context){
        ...
        if(bg){
          if(this.isCenter) {
            ...
            if(this.roundFill) {
                this._fillRoundRect(context,-me.width/2-10, -me.height/2, me.width+20, me.height,6);
            }
            else
                context.fillRect(-me.width/2, -me.height/2, me.width, me.height);
          }
          else {
            context.fillStyle = bg;
            if(this.roundFill) {
              this._fillRoundRect(context,-10, 0, me.width+20, me.height,6);
            }
            else
    ...
    _fillRoundRect : function(context,x,y,width,height,radius) {
      if(2*radius>width || 2*radius>height){return false;}
      context.save();
      context.translate(x,y);
      //绘制圆角矩形的各个边
      this._drawRoundRectPath(context,width,height,radius);
      context.fill();
      context.restore();
    },

    _drawRoundRectPath:function(context,width,height,radius) {
      context.beginPath(0);
    ...
    _drawTextLine: function(context, text, y){
        ...
        if(this.isCenter) {
          if(me.outline) context.strokeText(text, x-me.width/2, y-me.height/2);
          else context.fillText(text, x-me.width/2, y-me.height/2);
        } else {
...
(function(window){
  ...
  var Hilo = window.Hilo;var View = window.Hilo.View;
  var CacheMixin = window.Hilo.CacheMixin;
  var SpeechBubble = window.SpeechBubble;
   ...
   * @property {Number} textHeight Height of the text, readonly! Works only on canvas mode.
   */
  var BubbleText = Class.create(/** @lends Text.prototype */{
    Extends: View,
    Mixes:CacheMixin,
    constructor: function(properties){
      properties = properties || {};
      this.id = this.id || properties.id || Hilo.getUid('BubbleText');
      BubbleText.superclass.constructor.call(this, properties);
      this.beginX = properties.beginX;
      this.beginY = properties.beginY;
      this.chat = (typeof properties.chat != "undefined") ? properties.chat : true;
      this.scalePanel =(typeof properties.scalePanel != "undefined") ? properties.scalePanel  : 1;
      this.shardowEffect = (typeof properties.shardowEffect != "undefined") ?  properties.shardowEffect : false;
      this.panelBorderColor = (typeof properties.panelBorderColor != "undefined") ? properties.panelBorderColor : "#fadf42";
      this.panelFillColor = (typeof properties.panelFillColor != "undefined") ? properties.panelFillColor : "#fadf42";
      this.panelBorderWidth = (typeof properties.panelBorderWidth != "undefined") ? properties.panelBorderWidth : 2;
      this.fontName = (typeof properties.fontName != "undefined") ? properties.fontName : "Arial";
      this.fontColor = (typeof properties.fontColor != "undefined") ? properties.fontColor : "#656c78";
      this.fontSize = (typeof properties.fontSize != "undefined") ? properties.fontSize : 20;
      this.fixedSize = (typeof properties.fixedSize != "undefined") ? properties.fixedSize : false;
      this.width = (typeof properties.width != "undefined") ? properties.width : 300;
      this.height = (typeof properties.height != "undefined") ? properties.height : 100;
      this.text = (typeof properties.text != "undefined") ? properties.text : "";
      this.chatLeftOrRight = (typeof properties.chatLeftOrRight != "undefined") ? properties.chatLeftOrRight : false;
      // if(!properties.width) this.width = 200; //default width
      if(!properties.font) this.font = '12px arial'; //default font style
      this._fontHeight = BubbleText.measureFontHeight(this.font);
    },
    text: null,
    color: '#000',
    textAlign: null,
    ...
    _draw: function(context) {
      ...
      if(me.speechBubble==null) {
        me.speechBubble =  new SpeechBubble(context,this.chat,this.scalePanel,this.shardowEffect,this.panelBorderColor,this.panelFillColor,this.panelBorderWidth,this.fontColor,this.fontSize,this.fixedSize,this.width,this.height,this.fontName,this.text,this.chatLeftOrRight);
        me.speechBubble.text = me.text;
        if(this.chatLeftOrRight==true) {
          me.pivotX = me.speechBubble.getBubbleWidth();
        }
      }
      // Draw SpeechBubble

      if(me.drawCount++ > 0)
        me.speechBubble.draw(context);
      // var me = this, text = me.text.toString();
      // if(!text) return;
      //
      // //set drawing style
  ...
  window.Hilo.BubbleText = BubbleText;
})(window);
/**
 * Hilo 1.6.0 for standalone
 * Copyright 2016 alibaba.com
